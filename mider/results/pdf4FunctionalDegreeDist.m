...
[tDegreeAxis,tDePdenf] = plpdf_Parameter1(tDegree,6,[0,185/255,0],'o');hold on % title('Histogram For \alpha Diversity Over Days (Transitory)')
...
[tDistAxis,tDistPdenf] = plpdf_Parameter1(tDistance,0.1,[0,185/255,0],'o');hold on % title('Histogram For \alpha Diversity Over Days (Transitory)')
