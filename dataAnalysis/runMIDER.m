...
%--------------------------------------------------------------------------
% Copyright (C) 2015  Alejandro Fern·ndez Villaverde
% 
...
addpath(genpath('results')); 
       ...
       % 'Healthy_A1_IBS'      -->     'output_Healthy_A';
       % 'Healthy_B1_IBS'      -->     'output_Healthy_B';
       % 'Healthy_C_1_IBS'     -->     'output_Healthy_C';
       % 'Healthy_C1_1_IBS'    -->     'output_Healthy_C1';
       % 'Unhealthy_D1_IBS'    -->     'output_Unhealthy_D'
       % 'Unhealthy_E1_IBS'    -->     'output_Unhealthy_E'; 
       % 'Healthy_Group_IBS'   -->     'output_Healthy_Group';
       % 'Unhealthy_Group_IBS' -->     'output_Unhealthy_Group';
       % 'All_Group_IBS'       -->     'output_All_Group';
       % 'Healthy_Group_IBS_withoutC_C1'   -->     'output_Healthy_Group_withoutC_C1';
       % 'UnHealthy_Group_IBS_withoutC_C1' -->     'output_Unhealthy_Group_withoutC_C1';
       % 'All_Group_IBS_withoutC_C1'       -->     'output_All_Group_withoutC_C1';
       % 'Transitory_Group_IBS'-->     'output_Transitory_Group';
       % 'Healthy_State_1_Data'-->     'output_Healthy_State_1';
       % 'Transitory_State_1_Data' --> 'output_Transitory_State_1'
       % 'Transitory_State_2_Data' --> 'output_Transitory_State_2'
       % 'Unhealthy_State_1_Data'  --> 'output_Unhealthy_State_1'(Invalid now)
       % 'Unhealthy_State_2_Data'  --> 'output_Unhealthy_State_2'
       % 'Unhealthy_State_3_Data'  --> 'output_Unhealthy_State_3'
       % 'fishData'                --> 'output_fishData'
       % 'fishData_Cold'           --> 'output_fishDataCold'
       % 'fishData_Hot'            --> 'output_fishDataHot'
       % 'fishData_Spring'         --> 'output_fishDataSpring'
       % 'fishData_Summer'         --> 'output_fishDataSummer'
       % 'fishData_Autumn'         --> 'output_fishDataAutumn'
       % 'fishData_Winter'         --> 'output_fishDataWinter'
% Input data file:
datafile = 'fishData';
% Results file:
resultfile = 'results/output_fishData.mat';
...
%--------------------------------------------------------------------------
% Calculate Shannon's Entropy. Added by Jie Li, 2018-6-2
p = 10; % Parameter for Kernel Density Estimation. Microbiome”√µƒ «0.0001
Output.H = calShannonEntropy(x,p);
