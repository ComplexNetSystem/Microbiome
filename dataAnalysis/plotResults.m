...
%% Modification for distance. (Delete if...end for cancelling modification) on 2018.5.23 by Li Jie.
...
% axis([minaxis maxaxis minaxis maxaxis]); % Modification (Mixed range) on 2018.5.23 by Li Jie.
axis([-20 20 -20 20])
axis equal
